...
class OfficesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create office" do
    assert_difference('Office.count') do
      post offices_url, params: { office: { location: @office.location, office_number: @office.office_number, professor_id: @office.professor_id } }
    end
  ...
  test "should update office" do
    patch office_url(@office), params: { office: { location: @office.location, office_number: @office.office_number, professor_id: @office.professor_id } }
