...
class ProfessorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create professor" do
    assert_difference('Professor.count') do
      post professors_url, params: { professor: { class_assignment: @professor.class_assignment, first_name: @professor.first_name, last_name: @professor.last_name, office_number: @professor.office_number } }
    end
  ...
  test "should update professor" do
    patch professor_url(@professor), params: { professor: { class_assignment: @professor.class_assignment, first_name: @professor.first_name, last_name: @professor.last_name, office_number: @professor.office_number } }
